                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/pages/theloai/danhsach">Danh sách thể loại</a>
                                </li>
                                <li>
                                    <a href="admin/pages/theloai/getthem">Thêm Thể Loại</a>
                                </li>
                                 <li>
                                    <a href="admin/pages/theloai/sua">Sửa Thể Loại</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
